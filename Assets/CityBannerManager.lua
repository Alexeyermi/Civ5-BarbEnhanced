...
-- Added by Nutty 3/16/2014 to control city banner offset
local bRaiseUnitIcon = false;
local bLowerUnitIcon = false;

--LuaEvents.ToggleRaiseCityBanner.Add(
--function()
--	if (bRaiseUnitIcon) then
--		bRaiseUnitIcon = false;
--	else
--		bRaiseUnitIcon = true;
--	end
--end);
--LuaEvents.ToggleHideGarrisonFrame.Add(
--function()
--	if (bLowerUnitIcon) then
--		bLowerUnitIcon = false;
--	else
--		bLowerUnitIcon = true;
--	end
--end);
...
local Instances = {};
local SVInstances = {};
-- Modified by Nutty 3/16/2014 to control city banner offset
--local WorldPositionOffsetX = 0;
--local WorldPositionOffsetY = 0;
local WorldPositionOffsetZ = 0;
if (bRaiseUnitIcon) then
	WorldPositionOffsetZ = 12;
end
local WorldPositionOffset = { x = 0, y = 0, z = 35 + WorldPositionOffsetZ };
-- End Modify
...
function RefreshCityBanner(cityBanner, iActiveTeam, iActivePlayer)
	...
	if city ~= nil then
		...
		-- Added for Barbarians Enhanced
		-- Don't show tooltip for Barbarian Minors
		if player:GetTeam() == GameDefines.MAX_CIV_PLAYERS then
		...
		-- Modified by Nutty 3/16/2014 to control hiding of the garrison frame
		if (not bLowerUnitIcon) then
...
function SetUpMinorMeter( iMajor, iMinor, controls, minorColor )
	...
	-- Added for Barbarians Enhanced
	-- Don't show meter for Barbarian Minors
	if Players[iMinor]:GetTeam() == GameDefines.MAX_CIV_PLAYERS then
		controls.StatusMeterFrame:SetHide(true);
		controls.StatusIconBG:SetHide(true);
